...
private const val DETAIL_HERO_BACKGROUND_SCALE = 1.14f
private const val DETAIL_HERO_SCROLL_PARALLAX = 0.3f
private const val DETAIL_HERO_SCROLL_DOWN_SCALE_MULTIPLIER = 0.0001f
private const val DETAIL_HERO_SCROLL_UP_SCALE_MULTIPLIER = 0.002f
private const val DETAIL_HERO_SCROLL_MAX_SCALE = 1.3f
...
fun DetailHero(
    ...
    BoxWithConstraints(
        ...
        val scrollOffsetPx = scrollOffset.toFloat()
        val heroScrollScale = detailHeroBackgroundScrollScale(scrollOffsetPx)
        val heroScrollTranslationY = detailHeroBackgroundScrollTranslationY(scrollOffsetPx)
                    ...
                    AsyncImage(
                        ...
                        modifier = Modifier
                            ...
                            .graphicsLayer {
                                ...
                                scaleX = DETAIL_HERO_BACKGROUND_SCALE * heroScrollScale
                                scaleY = DETAIL_HERO_BACKGROUND_SCALE * heroScrollScale
                            },
...
private fun detailHeroBackgroundScrollScale(scrollOffsetPx: Float): Float {
    val scaleIncrease = if (scrollOffsetPx < 0f) {
        abs(scrollOffsetPx) * DETAIL_HERO_SCROLL_UP_SCALE_MULTIPLIER
    } else {
        scrollOffsetPx * DETAIL_HERO_SCROLL_DOWN_SCALE_MULTIPLIER
    }
    return (1f + scaleIncrease).coerceAtMost(DETAIL_HERO_SCROLL_MAX_SCALE)
}

private fun detailHeroBackgroundScrollTranslationY(scrollOffsetPx: Float): Float =
    scrollOffsetPx * DETAIL_HERO_SCROLL_PARALLAX
